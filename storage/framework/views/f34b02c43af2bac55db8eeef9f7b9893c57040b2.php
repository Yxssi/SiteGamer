...
<div class="col-md-12">
    <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-sm btn-secondary mt-3">Revenir au panier</a>
    <div class="row">
        <div class="col-md-6 mx-auto">
            ...
            <form action="<?php echo e(route('checkout.store')); ?>" method="POST" class="my-4" id="payment-form">
                ...
                <button class="btn btn-success btn-block mt-3" id="submit">
                    <i class="fa fa-credit-card" aria-hidden="true"></i> Payer maintenant (<?php echo e(getPrice($total)); ?>)
                </button>
            </form>
        </div>
    </div>
...
<script>
    ...
    // Paiement Stripe
    var stripe = Stripe('pk_test_zGt6oxmrgNBoR3hxzCihzNhG004xpM3K9k');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/serverphp/e-commerce-master/Gamerz/resources/views/checkout/index.blade.php ENDPATH**/ ?>